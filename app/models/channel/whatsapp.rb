...
#  index_channel_whatsapp_session_id                         (((provider_config ->> 'session_id'::text))) WHERE ((provider)::text = ANY ((ARRAY['native'::character varying, 'uazapi'::character varying])::text[]))
#

class Api::V1::Accounts::RedirectTokensController < Api::V1::Accounts::BaseController
  def create
    ...
    payload = { identifier: permitted_params[:identifier], message: permitted_params[:message] }.compact
    ttl = permitted_params[:ttl_seconds].presence&.to_i || ::Widget::RedirectToken::DEFAULT_TTL

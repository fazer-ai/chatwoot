...
import FooterReplyTo from 'simulator/components/FooterReplyTo.vue';
import ChatInputWrap from 'simulator/components/ChatInputWrap.vue';
import { BUS_EVENTS } from 'shared/constants/busEvents';
import { sendEmailTranscript } from 'simulator/api/conversation';

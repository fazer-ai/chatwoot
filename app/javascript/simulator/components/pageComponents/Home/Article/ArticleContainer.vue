...
import ArticleBlock from 'simulator/components/pageComponents/Home/Article/ArticleBlock.vue';
import ArticleCardSkeletonLoader from 'simulator/components/pageComponents/Home/Article/SkeletonLoader.vue';

...
const showAiStatusActions = ref(false);

function onSetAiStatusForBulk(aiEnabled) {
  showAiStatusActions.value = false;
  onSetAiStatus(aiEnabled);
}
    ...
    >
      ...
      >
        <div class="ltr:ml-0.5 rtl:mr-0.5 flex items-center gap-1">
          <label class="cursor-pointer flex items-center gap-1.5 text-[10px]">
            <Checkbox
              v-model="allSelected"
          ...
          <NextButton
            ...
            ghost
            class="!text-n-blue-11 !text-[10px] !px-1 !h-6 flex-shrink-0 [&>span]:!whitespace-nowrap [&>span]:!overflow-visible"
            xs
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="relative">
            <NextButton
              ...
              xs
              faded
              @click="showAiStatusActions = !showAiStatusActions"
            />
            <AiStatusActions
              v-if="showAiStatusActions"
              class="absolute bottom-full mb-2 right-0 z-30"
              @set-ai-status="onSetAiStatusForBulk"

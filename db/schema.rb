...
ActiveRecord::Schema[7.1].define(version: 2026_08_17_120000) do
  ...
  create_table "channel_whatsapp", force: :cascade do |t|
    ...
    t.index ["provider_connection"], name: "index_channel_whatsapp_provider_connection", where: "((provider)::text = ANY ((ARRAY['baileys'::character varying, 'zapi'::character varying, 'native'::character varying, 'uazapi'::character varying])::text[]))", using: :gin
  end

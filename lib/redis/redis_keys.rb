module Redis::RedisKeys
  ...
  # Marks an inbound message this app has just acknowledged to WhatsApp, so the provider's echo of that
  # receipt is not read back as a device of this account opening the chat.
  WHATSAPP_SELF_READ_RECEIPT = 'WHATSAPP_SELF_READ_RECEIPT::%<message_id>s'.freeze
